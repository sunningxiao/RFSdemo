...
class MAIN(QtWidgets.QWidget, Ui_Form):
    def __init__(self, ui_parent):
        ...
        #
        self.intrigtimes = self.repeat_times.text()
    ...
    def addawg(self, tabname, chnlnum):
        ...
        if self.chnlnum != 0:
            self.scrollArea_2.addWidget(self.wave(chnlnum))
            self.chnlnum = self.chnlnum - 1


    def wave(self, chnl_num):
        self.chnl_num = chnl_num
        self.chnl_8.setText("chnlnum".format(chnl_num))
        self.chnl_wave_6.addWidget(self.waveform)

    def waveform(self,plotdate):
        pass
