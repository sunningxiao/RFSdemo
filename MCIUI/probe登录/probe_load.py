...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ADrate = QtWidgets.QLineEdit(self.widget_3)
        self.ADrate.setObjectName("ADrate")
        self.gridLayout.addWidget(self.ADrate, 1, 1, 1, 1)
...
"margin-right:10px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Connect Probe"))
        self.label_2.setText(_translate("Form", "device ip"))
        self.label_3.setText(_translate("Form", "ADrate"))
