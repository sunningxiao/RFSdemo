...
class Ui_addtab(object):
    def setupUi(self, addtab):
        ...
        self.textEditpy = QtWidgets.QTextEdit(self.frame_35)
        self.textEditpy.setStyleSheet("<script src=\"https://cdnjs.cloudflare.com/ajax/libs/prism/1.17.1/prism.min.js\"></script>\n"
"\n"
