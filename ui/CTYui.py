...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_show_spectrum.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.gridLayout_5.addWidget(self.label_23, 3, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.line_2, 6, 0, 1, 9)
        ...
        self.txt_dds_fc.setMaximumSize(QtCore.QSize(130, 16777215))
        self.txt_dds_fc.setObjectName("txt_dds_fc")
        self.gridLayout_5.addWidget(self.txt_dds_fc, 3, 4, 1, 1)
        ...
        self.txt_gate_delay.setMaximumSize(QtCore.QSize(130, 16777215))
        self.txt_gate_delay.setObjectName("txt_gate_delay")
        self.gridLayout_5.addWidget(self.txt_gate_delay, 4, 6, 1, 1)
        self.label_7 = QtWidgets.QLabel(self.frame_4)
        self.label_7.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_7.setObjectName("label_7")
        self.gridLayout_5.addWidget(self.label_7, 3, 7, 1, 1)
        ...
        self.txt_gate_width.setMaximumSize(QtCore.QSize(130, 16777215))
        self.txt_gate_width.setObjectName("txt_gate_width")
        self.gridLayout_5.addWidget(self.txt_gate_width, 4, 8, 1, 1)
        self.btn_start = QtWidgets.QPushButton(self.frame_4)
        self.btn_start.setMaximumSize(QtCore.QSize(100, 16777215))
        self.btn_start.setObjectName("btn_start")
        self.gridLayout_5.addWidget(self.btn_start, 10, 0, 1, 1)
        ...
        self.txt_dds_band.setMaximumSize(QtCore.QSize(130, 16777215))
        self.txt_dds_band.setObjectName("txt_dds_band")
        self.gridLayout_5.addWidget(self.txt_dds_band, 3, 6, 1, 1)
        self.line = QtWidgets.QFrame(self.frame_4)
        self.line.setLineWidth(6)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayout_5.addWidget(self.line, 2, 0, 1, 9)
        ...
        self.gridLayout_5.addWidget(self.label_13, 4, 7, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.label_6, 3, 5, 1, 1)
        self.txt_dds_pulse = QtWidgets.QLineEdit(self.frame_4)
        self.txt_dds_pulse.setMaximumSize(QtCore.QSize(130, 16777215))
        self.txt_dds_pulse.setObjectName("txt_dds_pulse")
        self.gridLayout_5.addWidget(self.txt_dds_pulse, 3, 8, 1, 1)
        self.label_12 = QtWidgets.QLabel(self.frame_4)
        self.label_12.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_12.setObjectName("label_12")
        self.gridLayout_5.addWidget(self.label_12, 4, 5, 1, 1)
        ...
        self.select_source.setMaximumSize(QtCore.QSize(130, 16777215))
        self.select_source.setObjectName("select_source")
        self.select_source.addItem("")
        self.select_source.addItem("")
        self.gridLayout_5.addWidget(self.select_source, 4, 4, 1, 1)
        ...
        self.txt_sampling_delay.setMaximumSize(QtCore.QSize(130, 16777215))
        self.txt_sampling_delay.setObjectName("txt_sampling_delay")
        self.gridLayout_5.addWidget(self.txt_sampling_delay, 5, 6, 1, 1)
        self.label_14 = QtWidgets.QLabel(self.frame_4)
        self.label_14.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_14.setObjectName("label_14")
        self.gridLayout_5.addWidget(self.label_14, 5, 5, 1, 1)
        self.label_15 = QtWidgets.QLabel(self.frame_4)
        self.label_15.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_15.setObjectName("label_15")
        self.gridLayout_5.addWidget(self.label_15, 5, 7, 1, 1)
        self.txt_sampling_points = QtWidgets.QLineEdit(self.frame_4)
        self.txt_sampling_points.setMaximumSize(QtCore.QSize(130, 16777215))
        self.txt_sampling_points.setObjectName("txt_sampling_points")
        self.gridLayout_5.addWidget(self.txt_sampling_points, 5, 8, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.btn_stop, 10, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.chk_write_file, 10, 2, 1, 1)
        self.label_18 = QtWidgets.QLabel(self.frame_4)
        self.label_18.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_18.setObjectName("label_18")
        self.gridLayout_5.addWidget(self.label_18, 10, 3, 1, 1)
        self.select_prf_src = QtWidgets.QComboBox(self.frame_4)
        ...
        self.select_prf_src.addItem("")
        self.gridLayout_5.addWidget(self.select_prf_src, 10, 4, 1, 1)
        self.label_17 = QtWidgets.QLabel(self.frame_4)
        self.label_17.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_17.setObjectName("label_17")
        self.gridLayout_5.addWidget(self.label_17, 10, 5, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.txt_prf_cnt, 10, 6, 1, 1)
        self.label_16 = QtWidgets.QLabel(self.frame_4)
        self.label_16.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_16.setObjectName("label_16")
        self.gridLayout_5.addWidget(self.label_16, 10, 7, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.txt_prf_cyc, 10, 8, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.btn_dss_cfg, 3, 0, 1, 1)
        ...
        self.dds_chose.addItem("")
        self.dds_chose.addItem("")
        self.gridLayout_5.addWidget(self.dds_chose, 5, 0, 1, 1)
        self.btn_wave = QtWidgets.QPushButton(self.frame_4)
        self.btn_wave.setMinimumSize(QtCore.QSize(0, 0))
        self.btn_wave.setMaximumSize(QtCore.QSize(100, 16777215))
        self.btn_wave.setObjectName("btn_wave")
        self.gridLayout_5.addWidget(self.btn_wave, 4, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_15.setText(_translate("Form", "采样点数(k)"))
        self.btn_stop.setText(_translate("Form", "系统停止"))
        self.chk_write_file.setText(_translate("Form", "落盘"))
        self.label_18.setText(_translate("Form", "基准PRF选择"))
        self.select_prf_src.setItemText(0, _translate("Form", "内部产生"))
        self.select_prf_src.setItemText(1, _translate("Form", "外部输入"))
