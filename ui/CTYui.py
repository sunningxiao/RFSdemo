...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_5.addWidget(self.chk_write_file, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.frame_2, 0, 0, 1, 8)
        self.textBrowser = QtWidgets.QTextBrowser(Form)
        self.textBrowser.setMaximumSize(QtCore.QSize(16777215, 150))
        self.textBrowser.setObjectName("textBrowser")
        self.gridLayout.addWidget(self.textBrowser, 2, 0, 1, 8)
        ...
        self.gridLayout.addWidget(self.btn_reload_icd, 3, 6, 1, 1)
