...
class Ui_CorePackTest(object):
    ...
    def setupUi(self, CorePackTest):
        ...
        self.network = QtWidgets.QPushButton(CorePackTest)
        self.network.setObjectName("network")
        self.gridLayout_4.addWidget(self.network, 2, 2, 1, 1)
        ...
        self.btn_serial_detial.hide()
        self.btn_rf_detial.hide()
        self.btn_chnl_detial.hide()
        self.btn_ddr_detial.hide()
        self.btn_gty_detial.hide()
        self.btn_gpio_detial.hide()
        self.btn_emmc_detial.hide()
        self.btn_output.hide()

        self.process_test_status = QtWidgets.QProgressBar(CorePackTest)
        self.process_test_status.setObjectName("test_status")
        self.gridLayout_2.addWidget(self.process_test_status, 3, 0, 1, 1)
        self.process_test_status.setMaximumSize(QtCore.QSize(16777215, 16777215))
        # self.test_status.setMaximum(0)
